...
sum = round(P2Lib1.sumList(wList), 2)
print('The summation of this population is {}'.format(sum))

mean = round(P2Lib1.meanList(wList), 2)
print("The mean of this population is {}".format(mean))

min, max = P2Lib1.minMaxList(wList)
print("The min and max of this population is {} and {}".format(min, max))

stdev = round(P2Lib1.stdevList(wList), 2)
print('The standard deviation of this population is {}'.format(stdev))